...
`char`는 Java처럼 2바이트 와이드캐릭터를 사용<br>

**문자열**
- `str`
`str`는 Rust처럼 문자열 리터럴입니다.
...
### List(v0.1~), Tuple(v0.2~)
#### 2-1. 고정 배열과 튜플
Nok lang에서는 [] 표현식으로 배열, 튜플, 을 동시에 정의합니다.

LLVM, Rust의 배열 선언방식과 유사한 점이 있습니다.
